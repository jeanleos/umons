...
HD_PWD='C:/test_vivado/project_1/project_1.runs/design_1_sum_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_sum_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_sum_0_0.tcl
