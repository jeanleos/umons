namespace eval ::optrace {
  variable script "C:/test_vivado/project_1/project_1.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/Jean-Léo/AppData/Roaming/Xilinx/Vivado/2024.2/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part tul.com.tw:pynq-z2:part0:1.0 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/test_vivado/project_1/project_1.cache/wt [current_project]
  set_property parent.project_path C:/test_vivado/project_1/project_1.xpr [current_project]
  set_property ip_repo_paths C:/test [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/test_vivado/project_1/project_1.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/test_vivado/project_1/project_1.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/test_vivado/project_1/project_1.srcs/sources_1/bd/design_1/design_1.bd
