...
__attribute__((sdx_kernel("sum", 0))) void sum(int mat[3*3], int *res) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=sum
# 6 "coef_add.cpp"
...
#pragma HLS INTERFACE s_axilite port=return bundle=CTRL_BUS
 ...
 int s = 0;
    ...
    VITIS_LOOP_13_1: for (int i = 0; i < 3; i++)
        VITIS_LOOP_14_2: for (int j = 0; j < 3; j++)
            s += mat[i*3 + j];
