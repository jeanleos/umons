...
entity myproject_axi_shl_64ns_32ns_64_2_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 64;  --data bitwidth
      din1_WIDTH : INTEGER := 64;    --shift control bitwidth
      dout_WIDTH : INTEGER := 64;  --output bitwidth
...
end entity myproject_axi_shl_64ns_32ns_64_2_1;
architecture rtl of myproject_axi_shl_64ns_32ns_64_2_1 is
