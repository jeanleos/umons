set moduleName sigmoid_array_array_ap_fixed_16_6_5_3_0_1u_sigmoid_config19_s
set isTopModule 0
...
set C_modelName {sigmoid<array,array<ap_fixed<16,6,5,3,0>,1u>,sigmoid_config19>}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "sigmoid_array_array_ap_fixed_16_6_5_3_0_1u_sigmoid_config19_s",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	sigmoid_array_array_ap_fixed_16_6_5_3_0_1u_sigmoid_config19_s {
		...
		res_V_data_V {Type O LastRead -1 FirstWrite 7}
