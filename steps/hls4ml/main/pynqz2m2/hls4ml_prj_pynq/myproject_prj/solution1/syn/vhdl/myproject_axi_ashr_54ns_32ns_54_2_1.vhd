...
entity myproject_axi_ashr_54ns_32ns_54_2_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 54;  --data bitwidth
      din1_WIDTH : INTEGER := 54;    --shift control bitwidth
      dout_WIDTH : INTEGER := 54;  --output bitwidth
      OP : INTEGER := 2;            --opcode: 0-shl, 1-lshr, 2-ashr
...
end entity myproject_axi_ashr_54ns_32ns_54_2_1;
architecture rtl of myproject_axi_ashr_54ns_32ns_54_2_1 is
