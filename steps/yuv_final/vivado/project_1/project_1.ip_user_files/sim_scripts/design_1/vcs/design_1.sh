...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jeanleo2/yuv_final/vivado/project_1/project_1.cache/compile_simlib/vcs"
  fi
