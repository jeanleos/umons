...
// wrapc file define:
#define AUTOTB_TVIN_mat "../tv/cdatafile/c.sum.autotvin_mat.dat"
#define AUTOTB_TVOUT_mat "../tv/cdatafile/c.sum.autotvout_mat.dat"
#define AUTOTB_TVIN_res "../tv/cdatafile/c.sum.autotvin_res.dat"
#define AUTOTB_TVOUT_res "../tv/cdatafile/c.sum.autotvout_res.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_res "../tv/rtldatafile/rtl.sum.autotvout_res.dat"
...
extern "C"
void sum_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_sum_hw(void* __xlx_apatb_param_mat, void* __xlx_apatb_param_res)
{
  static hls::sim::Register port0 {
    .name = "res",
    .width = 32,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_res),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_res),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_res),
#endif
  };
  port0.param = __xlx_apatb_param_res;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_mat),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_mat),
#endif
#endif
    .hasWrite = { false },
  };
  port1.param = { __xlx_apatb_param_mat };
  port1.mname = { "mat" };
  port1.nbytes = { 36 };
  ...
  try {
    ...
    sum_hw_stub_wrapper(__xlx_apatb_param_mat, __xlx_apatb_param_res);
