...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_local_V_data_0_V_dout { I 4 vector } out_local_V_data_0_V_empty_n { I 1 bit } out_local_V_data_0_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_local_V_data_1_V_dout { I 4 vector } out_local_V_data_1_V_empty_n { I 1 bit } out_local_V_data_1_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_local_V_data_2_V_dout { I 4 vector } out_local_V_data_2_V_empty_n { I 1 bit } out_local_V_data_2_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_local_V_data_3_V_dout { I 4 vector } out_local_V_data_3_V_empty_n { I 1 bit } out_local_V_data_3_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 1743 \
    name is_last_0_i_loc \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_is_last_0_i_loc \
    op interface \
    ports { is_last_0_i_loc_dout { I 1 vector } is_last_0_i_loc_empty_n { I 1 bit } is_last_0_i_loc_read { O 1 bit } } \
} "
}
