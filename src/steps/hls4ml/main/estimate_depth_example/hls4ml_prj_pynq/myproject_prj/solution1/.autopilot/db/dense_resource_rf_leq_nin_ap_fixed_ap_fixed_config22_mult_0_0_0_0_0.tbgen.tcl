set moduleName dense_resource_rf_leq_nin_ap_fixed_ap_fixed_config22_mult_0_0_0_0_0
set isTopModule 0
...
set C_modelName {dense_resource_rf_leq_nin<ap_fixed,ap_fixed,config22_mult>.0.0.0.0.0}
