...
set C_modelName {Loop_1_proc700}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_local_V_data_0_V int 4 regular {fifo 1 volatile }  }
	{ in_local_V_data_1_V int 4 regular {fifo 1 volatile }  }
	{ in_local_V_data_2_V int 4 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "in_local_V_data_0_V", "interface" : "fifo", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
 	{ "Name" : "in_local_V_data_1_V", "interface" : "fifo", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
 	{ "Name" : "in_local_V_data_2_V", "interface" : "fifo", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ is_last_0_i_out_out_din sc_out sc_lv 1 signal 5 } 
	{ is_last_0_i_out_out_full_n sc_in sc_logic 1 signal 5 } 
	{ is_last_0_i_out_out_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_local_V_data_0_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "in_local_V_data_0_V", "role": "din" }} , 
 	...
 	{ "name": "in_local_V_data_1_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "in_local_V_data_1_V", "role": "din" }} , 
 	...
 	{ "name": "in_local_V_data_2_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "in_local_V_data_2_V", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "106497", "EstimateLatencyMax" : "106497",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_in_data_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "106497", "Max" : "106497"}
	, {"Name" : "Interval", "Min" : "106497", "Max" : "106497"}
]}
...
set Spec2ImplPortList { 
	in_local_V_data_0_V { ap_fifo {  { in_local_V_data_0_V_din fifo_data 1 4 }  { in_local_V_data_0_V_full_n fifo_status 0 1 }  { in_local_V_data_0_V_write fifo_update 1 1 } } }
	in_local_V_data_1_V { ap_fifo {  { in_local_V_data_1_V_din fifo_data 1 4 }  { in_local_V_data_1_V_full_n fifo_status 0 1 }  { in_local_V_data_1_V_write fifo_update 1 1 } } }
	in_local_V_data_2_V { ap_fifo {  { in_local_V_data_2_V_din fifo_data 1 4 }  { in_local_V_data_2_V_full_n fifo_status 0 1 }  { in_local_V_data_2_V_write fifo_update 1 1 } } }
