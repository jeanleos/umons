...
set DataType0 [list "input_axi_t" "struct in_struct" $structMem0 0 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "output_axi_t" "struct out_struct" $structMem1 0 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
