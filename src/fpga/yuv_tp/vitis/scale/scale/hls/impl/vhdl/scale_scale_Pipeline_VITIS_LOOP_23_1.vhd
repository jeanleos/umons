...
entity scale_scale_Pipeline_VITIS_LOOP_23_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of scale_scale_Pipeline_VITIS_LOOP_23_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln23_fu_149_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_tmp_data_1_reg_224 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_tmp_keep_reg_229 : STD_LOGIC_VECTOR (3 downto 0);
    signal p_tmp_keep_reg_229_pp0_iter2_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal p_tmp_keep_reg_229_pp0_iter3_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal p_tmp_strb_reg_234 : STD_LOGIC_VECTOR (3 downto 0);
    signal p_tmp_strb_reg_234_pp0_iter2_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal p_tmp_strb_reg_234_pp0_iter3_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal p_tmp_user_reg_239 : STD_LOGIC_VECTOR (1 downto 0);
    signal p_tmp_user_reg_239_pp0_iter2_reg : STD_LOGIC_VECTOR (1 downto 0);
    signal p_tmp_user_reg_239_pp0_iter3_reg : STD_LOGIC_VECTOR (1 downto 0);
    signal p_tmp_last_reg_244 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_tmp_last_reg_244_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal p_tmp_last_reg_244_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal p_tmp_id_reg_249 : STD_LOGIC_VECTOR (4 downto 0);
    signal p_tmp_id_reg_249_pp0_iter2_reg : STD_LOGIC_VECTOR (4 downto 0);
    signal p_tmp_id_reg_249_pp0_iter3_reg : STD_LOGIC_VECTOR (4 downto 0);
    signal p_tmp_dest_reg_254 : STD_LOGIC_VECTOR (5 downto 0);
    signal p_tmp_dest_reg_254_pp0_iter2_reg : STD_LOGIC_VECTOR (5 downto 0);
    signal p_tmp_dest_reg_254_pp0_iter3_reg : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_out_reg_259 : STD_LOGIC_VECTOR (24 downto 0);
    signal i_fu_74 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000000000000000000000";
    signal add_ln23_fu_155_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_load : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_block_pp0_stage0_01001_grp1 : BOOLEAN;
    signal i_cast_fu_145_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln23_fu_149_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_74 <= add_ln23_fu_155_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                p_tmp_data_1_reg_224 <= ch_in_TDATA;
                p_tmp_dest_reg_254 <= ch_in_TDEST;
                p_tmp_id_reg_249 <= ch_in_TID;
                p_tmp_keep_reg_229 <= ch_in_TKEEP;
                p_tmp_last_reg_244 <= ch_in_TLAST;
                p_tmp_strb_reg_234 <= ch_in_TSTRB;
                p_tmp_user_reg_239 <= ch_in_TUSER;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1)) then
                p_tmp_dest_reg_254_pp0_iter2_reg <= p_tmp_dest_reg_254;
                p_tmp_dest_reg_254_pp0_iter3_reg <= p_tmp_dest_reg_254_pp0_iter2_reg;
                p_tmp_id_reg_249_pp0_iter2_reg <= p_tmp_id_reg_249;
                p_tmp_id_reg_249_pp0_iter3_reg <= p_tmp_id_reg_249_pp0_iter2_reg;
                p_tmp_keep_reg_229_pp0_iter2_reg <= p_tmp_keep_reg_229;
                p_tmp_keep_reg_229_pp0_iter3_reg <= p_tmp_keep_reg_229_pp0_iter2_reg;
                p_tmp_last_reg_244_pp0_iter2_reg <= p_tmp_last_reg_244;
                p_tmp_last_reg_244_pp0_iter3_reg <= p_tmp_last_reg_244_pp0_iter2_reg;
                p_tmp_strb_reg_234_pp0_iter2_reg <= p_tmp_strb_reg_234;
                p_tmp_strb_reg_234_pp0_iter3_reg <= p_tmp_strb_reg_234_pp0_iter2_reg;
                p_tmp_user_reg_239_pp0_iter2_reg <= p_tmp_user_reg_239;
                p_tmp_user_reg_239_pp0_iter3_reg <= p_tmp_user_reg_239_pp0_iter2_reg;
                tmp_out_reg_259 <= grp_fu_130_p_dout0(31 downto 7);
            end if;
        end if;
    end process;
    ...
    add_ln23_fu_155_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv31_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln23_fu_149_p2)
    begin
        if (((icmp_ln23_fu_149_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_i_load_assign_proc : process(ap_CS_fsm_pp0_stage0, i_fu_74, ap_loop_init, ap_block_pp0_stage0)
    begin
    ...
    begin
        ...
        ch_out_TDATA <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_out_reg_259),32));
    ...
    ch_out_TDEST <= p_tmp_dest_reg_254_pp0_iter3_reg;
    ch_out_TID <= p_tmp_id_reg_249_pp0_iter3_reg;
    ch_out_TKEEP <= p_tmp_keep_reg_229_pp0_iter3_reg;
    ch_out_TLAST <= p_tmp_last_reg_244_pp0_iter3_reg;
    ch_out_TSTRB <= p_tmp_strb_reg_234_pp0_iter3_reg;
    ch_out_TUSER <= p_tmp_user_reg_239_pp0_iter3_reg;
    ...
    grp_fu_130_p_ce <= grp_fu_133_ce;
    grp_fu_130_p_din0 <= p_tmp_data_1_reg_224;
    grp_fu_130_p_din1 <= scale_factor;

    grp_fu_133_ce_assign_proc : process(ap_block_pp0_stage0_11001_grp1)
    begin
        if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1)) then 
    ...
    i_cast_fu_145_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_load),32));
    icmp_ln23_fu_149_p2 <= "1" when (signed(i_cast_fu_145_p1) < signed(total_data)) else "0";
end behav;
