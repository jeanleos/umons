; ModuleID = '/home/jeanleo2/yuv_tp/vitis/scale/scale/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define i32 @apatb_scale_ir(i32 %scale_factor, i32 %width, i32 %height, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull dereferenceable(12) %ch_in, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull dereferenceable(12) %ch_out) local_unnamed_addr #0 {
entry:
  %ch_in_copy.data = alloca i32, align 512
  %ch_in_copy.keep = alloca i4, align 512
  %ch_in_copy.strb = alloca i4, align 512
  %ch_in_copy.user = alloca i2, align 512
  %ch_in_copy.last = alloca i1, align 512
  %ch_in_copy.id = alloca i5, align 512
  %ch_in_copy.dest = alloca i6, align 512
  %ch_out_copy.data = alloca i32, align 512
  %ch_out_copy.keep = alloca i4, align 512
  %ch_out_copy.strb = alloca i4, align 512
  %ch_out_copy.user = alloca i2, align 512
  %ch_out_copy.last = alloca i1, align 512
  %ch_out_copy.id = alloca i5, align 512
  %ch_out_copy.dest = alloca i6, align 512
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* nonnull %ch_in, i32* nonnull align 512 %ch_in_copy.data, i4* nonnull align 512 %ch_in_copy.keep, i4* nonnull align 512 %ch_in_copy.strb, i2* nonnull align 512 %ch_in_copy.user, i1* nonnull align 512 %ch_in_copy.last, i5* nonnull align 512 %ch_in_copy.id, i6* nonnull align 512 %ch_in_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* nonnull %ch_out, i32* nonnull align 512 %ch_out_copy.data, i4* nonnull align 512 %ch_out_copy.keep, i4* nonnull align 512 %ch_out_copy.strb, i2* nonnull align 512 %ch_out_copy.user, i1* nonnull align 512 %ch_out_copy.last, i5* nonnull align 512 %ch_out_copy.id, i6* nonnull align 512 %ch_out_copy.dest)
  %0 = call i32 @apatb_scale_hw(i32 %scale_factor, i32 %width, i32 %height, i32* %ch_in_copy.data, i4* %ch_in_copy.keep, i4* %ch_in_copy.strb, i2* %ch_in_copy.user, i1* %ch_in_copy.last, i5* %ch_in_copy.id, i6* %ch_in_copy.dest, i32* %ch_out_copy.data, i4* %ch_out_copy.keep, i4* %ch_out_copy.strb, i2* %ch_out_copy.user, i1* %ch_out_copy.last, i5* %ch_out_copy.id, i6* %ch_out_copy.dest)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %ch_in, i32* %ch_in_copy.data, i4* %ch_in_copy.keep, i4* %ch_in_copy.strb, i2* %ch_in_copy.user, i1* %ch_in_copy.last, i5* %ch_in_copy.id, i6* %ch_in_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %ch_out, i32* %ch_out_copy.data, i4* %ch_out_copy.keep, i4* %ch_out_copy.strb, i2* %ch_out_copy.user, i1* %ch_out_copy.last, i5* %ch_out_copy.id, i6* %ch_out_copy.dest)
  ret i32 %0
}
...
declare i32 @apatb_scale_hw(i32, i32, i32, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*)
...
declare i32 @scale_hw_stub(i32, i32, i32, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull)

define i32 @scale_hw_stub_wrapper(i32, i32, i32, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*) #5 {
entry:
  %17 = call i8* @malloc(i64 12)
  %18 = bitcast i8* %17 to %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"*
  %19 = call i8* @malloc(i64 12)
  %20 = bitcast i8* %19 to %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"*
  call void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %18, i32* %3, i4* %4, i4* %5, i2* %6, i1* %7, i5* %8, i6* %9, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %20, i32* %10, i4* %11, i4* %12, i2* %13, i1* %14, i5* %15, i6* %16)
  %21 = call i32 @scale_hw_stub(i32 %0, i32 %1, i32 %2, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %18, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %20)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %18, i32* %3, i4* %4, i4* %5, i2* %6, i1* %7, i5* %8, i6* %9, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %20, i32* %10, i4* %11, i4* %12, i2* %13, i1* %14, i5* %15, i6* %16)
