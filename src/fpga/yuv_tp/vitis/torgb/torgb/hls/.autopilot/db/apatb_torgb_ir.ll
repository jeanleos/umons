; ModuleID = '/home/jeanleo2/yuv_tp/vitis/torgb/torgb/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define i32 @apatb_torgb_ir(i32 %width, i32 %height, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull dereferenceable(12) %ch_y, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull dereferenceable(12) %ch_u, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull dereferenceable(12) %ch_v, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull dereferenceable(12) %ch_r, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull dereferenceable(12) %ch_g, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull dereferenceable(12) %ch_b) local_unnamed_addr #0 {
entry:
...
declare i32 @apatb_torgb_hw(i32, i32, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*)
...
declare i32 @torgb_hw_stub(i32, i32, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull)

define i32 @torgb_hw_stub_wrapper(i32, i32, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*, i32*, i4*, i4*, i2*, i1*, i5*, i6*) #5 {
entry:
