...
void XSum_Set_a(XSum *InstancePtr, u32 Data) {
    ...
    XSum_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XSUM_CTRL_BUS_ADDR_A_DATA, Data);
}
...
u32 XSum_Get_a(XSum *InstancePtr) {
    ...
    Data = XSum_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XSUM_CTRL_BUS_ADDR_A_DATA);
    return Data;
}
...
void XSum_Set_b(XSum *InstancePtr, u32 Data) {
    ...
    XSum_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XSUM_CTRL_BUS_ADDR_B_DATA, Data);
}
...
u32 XSum_Get_b(XSum *InstancePtr) {
    ...
    Data = XSum_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XSUM_CTRL_BUS_ADDR_B_DATA);
    return Data;
}

u32 XSum_Get_c(XSum *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XSum_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XSUM_CTRL_BUS_ADDR_C_DATA);
    return Data;
}

u32 XSum_Get_c_vld(XSum *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XSum_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XSUM_CTRL_BUS_ADDR_C_CTRL);
    return Data & 0x1;
}
