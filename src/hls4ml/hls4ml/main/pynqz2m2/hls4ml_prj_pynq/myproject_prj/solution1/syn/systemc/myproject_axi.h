...
struct myproject_axi : public sc_module {
    ...
    sc_signal< sc_logic > Loop_1_proc604_U0_ap_start;
    sc_signal< sc_logic > Loop_1_proc604_U0_start_full_n;
    sc_signal< sc_logic > Loop_1_proc604_U0_ap_done;
    sc_signal< sc_logic > Loop_1_proc604_U0_ap_continue;
    sc_signal< sc_logic > Loop_1_proc604_U0_ap_idle;
    sc_signal< sc_logic > Loop_1_proc604_U0_ap_ready;
    sc_signal< sc_logic > Loop_1_proc604_U0_start_out;
    sc_signal< sc_logic > Loop_1_proc604_U0_start_write;
    sc_signal< sc_lv<16> > Loop_1_proc604_U0_in_local_V_data_0_V_din;
    sc_signal< sc_logic > Loop_1_proc604_U0_in_local_V_data_0_V_write;
    sc_signal< sc_lv<16> > Loop_1_proc604_U0_in_local_V_data_1_V_din;
    sc_signal< sc_logic > Loop_1_proc604_U0_in_local_V_data_1_V_write;
    sc_signal< sc_lv<16> > Loop_1_proc604_U0_in_local_V_data_2_V_din;
    sc_signal< sc_logic > Loop_1_proc604_U0_in_local_V_data_2_V_write;
    sc_signal< sc_logic > Loop_1_proc604_U0_in_r_TREADY;
    sc_signal< sc_lv<1> > Loop_1_proc604_U0_is_last_0_i_out_out_din;
    sc_signal< sc_logic > Loop_1_proc604_U0_is_last_0_i_out_out_write;
    sc_signal< sc_logic > myproject_U0_input_11_V_data_0_V_read;
    sc_signal< sc_logic > myproject_U0_input_11_V_data_1_V_read;
    sc_signal< sc_logic > myproject_U0_input_11_V_data_2_V_read;
    sc_signal< sc_lv<16> > myproject_U0_layer19_out_V_data_V_din;
    sc_signal< sc_logic > myproject_U0_layer19_out_V_data_V_write;
    ...
    void thread_Loop_1_proc604_U0_ap_continue();
    void thread_Loop_1_proc604_U0_ap_start();
    void thread_Loop_1_proc604_U0_start_full_n();
