...
set ID 235
set hasByteEnable 0
set MemName shift_line_buffer_array_ap_fixed_4_2_5_3_0_4u_config9_s_line_buffer_Array_V_3tde
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_6_V_read { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_8_V_read { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_9_V_read { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_10_V_read { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_11_V_read { I 4 vector } } \
} "
}
