set moduleName sigmoid_array_array_ap_fixed_4_2_5_3_0_1u_sigmoid_config7_s
set isTopModule 0
...
set C_modelName {sigmoid<array,array<ap_fixed<4,2,5,3,0>,1u>,sigmoid_config7>}
...
set portList { 
	...
	{ res_V_data_V_din sc_out sc_lv 4 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "sigmoid_array_array_ap_fixed_4_2_5_3_0_1u_sigmoid_config7_s",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	sigmoid_array_array_ap_fixed_4_2_5_3_0_1u_sigmoid_config7_s {
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "905", "EstimateLatencyMax" : "905",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
